...
<div class="flex flex-col w-full h-full space-y-12">
  <div class="w-full">
    <h3 class="text-2xl font-medium">Change Email Address</h3>
    <div class="divider" />
    <Modal label="change-email" checked={emailModalOpen}>
      <span slot="trigger" class="btn btn-primary">Change Email Address</span>
      <h3 slot="heading">Change Your Email Address</h3>
      <form
        action="?/updateEmail"
        method="POST"
        class="space-y-2"
      ...
      >
        ...
        <button type="submit" class="btn btn-primary w-full disabled={loading}"
          >Change My Email Address</button
        >
      </form>
    </Modal>
  </div>
