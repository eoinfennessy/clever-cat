...
<div class="flex flex-col items-center h-full w-full">
    ...
    <p class="text-center mt-1">
        Or <a href="/register" class="text-primary font-medium hover:cursor-pointer hover:underline">register</a> for a new account
    </p>
        ...
        {#if form?.notVerified}
          <div class="alert alert-error shadow-lg w-full max-w-md">
            <div>
              ...
              <span>Verify your email before logging in</span>
            </div>
          </div>
        {/if}
    </form>
